#!/usr/bin/env python3
"""Validate deterministic invariants in resolve-ambiguous-tasks artifacts."""
...
PLACEHOLDER = re.compile(
    ...
    r"signals and success thresholds|boundary, abort conditions, reversibility|owner/date)\}",
    re.IGNORECASE,
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "READY contradictions in workflow artifacts."
        )
    )
