...
Use `making-architecture-decisions` when the specification selects or changes software/system architecture. User approval applies to the revised specification after fresh-context audit, not merely the first draft.
