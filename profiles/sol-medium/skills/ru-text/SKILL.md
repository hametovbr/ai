...
If the relative path cannot be resolved, locate `ru-text/references/scoring.md` with the runtime's file search (for example, `rg --files`) and use its parent directory.
