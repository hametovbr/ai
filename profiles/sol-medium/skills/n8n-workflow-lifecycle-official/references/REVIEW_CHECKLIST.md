...
A review agent may fix MUST FIX items when the review request already authorizes those changes. Otherwise, present the security and connection changes for approval before mutating the workflow.
