# ADR Templates and Management Examples

These examples and operational notes come from the source skill. Adapt them to repository conventions and verify version-specific claims before use.
